...
import { addTodo, deleteTodo, checkboxHandler, editHandler, saveModel } from './redux/actions/myAction';
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={styles.list}>
              ...
              <TouchableOpacity onPress={() => dispatch(editHandler(item.id), setNewInput(item.data), setisModalVisible(true))}>
                <Image
